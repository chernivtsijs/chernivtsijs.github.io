...
var data = { title: "ChernivtsiJS",
  ...
  speakers: [{ name: "Andrey Listochkin",
    ...
    topic: "🤫 Secret Topic 🤫",
    lightning: false }, { name: "Uri Goldstain",
    photo: "/images/speakers/uri-goldshtein.png",
    work: "The Guild, Ness Ziona, Israel",
    topic: "Redefining the Frontend Developer Role",
  ...
  partners: { platinum: [{ name: "Chernivtsi National University",
    ...
    info: [{ name: "Відділ комп’ютерних технологій ІФТКН ЧНУ",
      ...
      link: "//nodeschool.io/chernivtsi" }, { name: "Kottans",
      logo: "/images/partners/kottans.png",
      link: "//kottans.org/" }, { name: "<Input />",
      logo: "/images/partners/input-conf.png",
      link: "//inputconf.org/" }, { name: "KharkivFrontend",
      logo: "/images/partners/kharkivfrontend.png",
      link: "//kharkivfrontend.org/" }, { name: "TernopilJS",
      logo: "/images/partners/ternopiljs.png",
      link: "//youtube.com/c/ternopiljs" }, { name: "KharkivCSS",
      logo: "/images/partners/KharkivCSS_logo_text_rgb.svg",
      link: "http://kharkivcss.org/" }] },
